...
saveOptionsLocalStorage()</td></tr><tr valign="top"><td>tabShow</td><td>string</td><td>"tab2"</td></tr><tr valign="top"><td>setupUiFromLocalStorage</td><td>function</td><td>function () <br><br>Call this method on init to setup the UI by reading the user's
