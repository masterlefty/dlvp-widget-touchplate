            ...
            if (units != this.currentUnits) {
                ...
                if(this.currentUnits == "mm") {
                    if (tabShow == "tab1") {
                        ...
                        var currentFeedRate = $('#' + this.id + ' .frprobe-run4').val();
                        var currentPlateHt  = $('#' + this.id + ' .htplate-run4').val();
                        var currentZclear   = $('#' + this.id + ' .zclear-run4' ).val();
                        var updateFeedRate = currentFeedRate * 25.4;
                        var updatePlateHt  = currentPlateHt * 25.4;
                        var updateZclear   = currentZclear * 25.4;
                    
                        $('#' + this.id + ' .frprobe-run4').val(this.updateFeedRate);
                        $('#' + this.id + ' .htplate-run4').val(this.updatePlateHt);
                        $('#' + this.id + ' .zclear-run4').val(this.updateZclear);
                    }
                }
                else {
                    if (tabShow == "tab1") {
